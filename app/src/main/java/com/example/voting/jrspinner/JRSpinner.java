package com.example.voting.jrspinner;
...
public class JRSpinner extends AppCompatEditText {
    ...
    public boolean performClick() {
        if (!multiple) {
            ...
            dialog.show(findActivity(getContext()).getFragmentManager(), dialog.getTag());
        } else {
            ...
            multiDialog.show(findActivity(getContext()).getFragmentManager(), multiDialog.getTag());
        }
